...
exports.findAll = (req, res) => {
    ...
    Category.find(searchObj).sort({_id : -1})
    .then(category => {
        res.send(category);
    }).catch(err => {
        res.status(500).send({
...
exports.findOne = (req, res) => {
    Category.findById(req.params.userId)
    .then(user => {
        if(!user) {
...
exports.update = (req, res) => {
    ...
    Category.findByIdAndUpdate(req.params.userId, {
...
exports.delete = (req, res) => {
    Category.findByIdAndRemove(req.params.userId)
    .then(user => {
        if(!user) {
            return res.status(404).send({
                message: "User not found with id " + req.params.userId
